...
class ReceitaRepetirQuando extends AbstractValidator
{
    
    const MSG_DESPESA_REPETIR_QUANDO_REQUERIDA      = "msgReceitaRepetirQuandoRequerida";
    const MSG_DESPESA_REPETIR_QUANDO_NAO_INFORMAR   = "msgReceitaRepetirQuandoNaoInformar";
    const MSG_DESPESA_REPETIR_QUANDO_VALOR_INVALIDO = "msgReceitaRepetirQuandoValorInvalido";
