...
namespace Receita\Model\Filtro\Validacao;
...
class ReceitaRepetirOcorrencia extends AbstractValidator
{
    
    const MSG_DESPESA_REPETIR_OCORRENCIA_REQUERIDA      = "msgReceitaRepetirOcorrenciaRequerida";
    const MSG_DESPESA_REPETIR_OCORRENCIA_NAO_INFORMAR   = "msgReceitaRepetirOcorrenciaNaoInformar";
    const MSG_DESPESA_REPETIR_OCORRENCIA_VALOR_INVALIDO = "msgReceitaRepetirOcorrenciaValorInvalido";
